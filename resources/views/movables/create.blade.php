...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-rose-50/20 to-gray-100 flex flex-col relative font-sans">
    ...
    <x-header title="Agregar Bien Mueble" />

    <div class="flex flex-1 relative">

        <x-sidebar active="movables-create" />

        <main class="flex-1 p-3 md:p-8 overflow-y-auto w-full scroll-smooth pb-24 md:pb-8 md:ml-64">
            <div class="max-w-6xl mx-auto">

                <form action="{{ route('movables.store') }}" method="POST" class="space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                            ...
                            <div class="flex items-end">
                                <label class="flex items-center gap-3 cursor-pointer p-4 bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 w-full">
                                    <input type="checkbox" id="es_auto" name="es_auto" value="1" class="w-5 h-5 text-purple-600 rounded focus:ring-2 focus:ring-purple-500" onchange="togglePolizaSection()">
                    ...
                    <div class="form-card p-5 md:p-8 rounded-2xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
                            <div>
                                ...
                                <input type="number" name="cuenta" class="input-modern" required placeholder="Ej: 1234">
                            </div>
                            <div>
                                <label class="label-modern">Sub-Cuenta <span class="text-red-500">*</span></label>
                                <input type="number" name="sub_cuenta" class="input-modern" required placeholder="Ej: 56">
                            </div>
                            <div>
                                <label class="label-modern">Nombre de la Cuenta</label>
                                <input type="text" name="nombre_cuenta" class="input-modern" placeholder="Ej: Mobiliario y Equipo">
                            </div>
                            <div>
                                <label class="label-modern">Número de Inventario</label>
                                <input type="text" name="numero_inventario" class="input-modern" placeholder="Ej: INV-2024-001">
                            </div>
                            <div>
                                <label class="label-modern">Nombre del Resguardatario</label>
                                <input type="text" name="nombre_resguardatario" class="input-modern" placeholder="Ej: Juan Pérez">
                            </div>
                            <div>
                                <label class="label-modern">Área</label>
                                <input type="text" name="area" class="input-modern" placeholder="Ej: Sistemas">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-card p-5 md:p-8 rounded-2xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nombre_mueble" class="input-modern" placeholder="Ej: Escritorio ejecutivo">
                            </div>
                            <div>
                                <label class="label-modern">Marca</label>
                                <input type="text" name="marca" class="input-modern" placeholder="Ej: Dell">
                            </div>
                            <div>
                                <label class="label-modern">Modelo</label>
                                <input type="text" name="modelo" class="input-modern" placeholder="Ej: Latitude 5420">
                            </div>
                            <div>
                                <label class="label-modern">Número de Serie</label>
                                <input type="text" name="numero_serie" class="input-modern" placeholder="Ej: SN123456789">
                            </div>
                            <div id="campo-placa" style="display: none;">
                                <label class="label-modern">Número de Placa</label>
                                <input type="text" name="numero_placa" class="input-modern" placeholder="Ej: ABC-123">
                            </div>
                            <div id="campo-motor" class="md:col-span-2" style="display: none;">
                                <label class="label-modern">Número de Motor</label>
                                <input type="text" name="numero_motor" class="input-modern" placeholder="Ej: MOT123456">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-card p-5 md:p-8 rounded-2xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                            <div>
                                ...
                                <input type="number" name="factura_numero" class="input-modern" required placeholder="Ej: 12345">
                            </div>
                            <div>
                                <label class="label-modern">Fecha de Factura <span class="text-red-500">*</span></label>
                                <input type="datetime-local" name="factura_fecha" class="input-modern" required>
                            </div>
                            <div>
                                <label class="label-modern">Proveedor</label>
                                <input type="text" name="factura_proveedor" class="input-modern" placeholder="Ej: Compañía XYZ S.A.">
                            </div>
                            <div>
                                <label class="label-modern">Costo</label>
                                <input type="number" name="factura_costo" class="input-modern" placeholder="Ej: 15000">
                            </div>
                        </div>
                    </div>

                    {{-- Póliza (visible solo si es auto) --}}
                    <div id="poliza-section" class="form-card p-5 md:p-8 rounded-2xl" style="display: none;">
                        <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100/80">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
                            <div>
                                ...
                                <input type="text" id="poliza_tipo" name="poliza_tipo" class="input-modern" maxlength="1" placeholder="Ej: I, E, D">
                            </div>
                            <div>
                                <label class="label-modern">Número de Póliza <span class="text-red-500">*</span></label>
                                <input type="number" id="poliza_numero" name="poliza_numero" class="input-modern" placeholder="Ej: 123">
                            </div>
                            <div>
                                <label class="label-modern">Fecha de Póliza <span class="text-red-500">*</span></label>
                                <input type="datetime-local" id="poliza_fecha" name="poliza_fecha" class="input-modern">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-card p-5 md:p-8 rounded-2xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                            <div>
                                ...
                                <input type="datetime-local" name="fecha_movimiento_alta" class="input-modern" required>
                            </div>
                        </div>
                    </div>
